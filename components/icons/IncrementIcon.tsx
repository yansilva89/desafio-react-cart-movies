...
const Increment = styled(IncrementIcon)`
  width: 18px;
  height: 18px;
  fill: #009EDD;
  cursor: pointer;
...
`
function IncrementIcon({ className, onClick }: IncrementIconProps) {
  return (
    <svg className={ className } viewBox="0 0 18 18" onClick={onClick} fill="none" xmlns="http://www.w3.org/2000/svg">
